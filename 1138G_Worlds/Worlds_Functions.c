...
int Lookup_Sweetspot (int Location)
{
	...
	switch(Location)
	{
		...
		case 2:	//Skills shot
			...
			if      (battVoltage >= 8.60) {tableSpeed = 38.0;}
			else if (battVoltage >= 8.55) {tableSpeed = 38.5;}
			else if (battVoltage >= 8.50) {tableSpeed = 39.0;}
			else if (battVoltage >= 8.45) {tableSpeed = 39.5;}
			else if (battVoltage >= 8.40) {tableSpeed = 40.0;}
			else if (battVoltage >= 8.35) {tableSpeed = 41.0;}
			else if (battVoltage >= 8.30) {tableSpeed = 42.0;}
			else if (battVoltage >= 8.25) {tableSpeed = 43.0;}
			else if (battVoltage >= 8.20) {tableSpeed = 43.5;}
			else if (battVoltage >= 8.15) {tableSpeed = 44.0;}
			else if (battVoltage >= 8.05) {tableSpeed = 44.5;}
			else if (battVoltage >= 8.00) {tableSpeed = 45.0;}
			else if (battVoltage >= 7.95) {tableSpeed = 46.0;}
			else if (battVoltage >= 7.90) {tableSpeed = 46.5;}
			else if (battVoltage >= 7.80) {tableSpeed = 47.0;}
			else if (battVoltage >= 7.75) {tableSpeed = 47.5;}
			else if (battVoltage >= 7.70) {tableSpeed = 48.0;}
			else if (battVoltage >= 7.65) {tableSpeed = 48.5;}
			else if (battVoltage >= 7.60) {tableSpeed = 49.0;}
			else if (battVoltage >= 7.55) {tableSpeed = 50.0;}
			else if (battVoltage >= 7.50) {tableSpeed = 51.0;}
			else 													{tableSpeed = 45.0;}
